...
export type FinanceSnapshot = {
  ...
  derived: {
    ...
    /**
     * Heuristic-only, based on utilization/balances. This is NOT a credit bureau score.
     * Included so UIs can show a "Credit Score estimate" without pulling credit reports.
     */
    credit_score_estimate: number | null
    credit_score_note: string | null
  } | null
}

function estimateCreditScoreFromUtilization(utilizationPct: number | null) {
