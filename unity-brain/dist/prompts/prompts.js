// Central prompt catalog (5-agent prompts + system rules).
// Keep all prompt strings in ONE place so any frontend only fetches "rules" from this API.
    ...
    return {
        ...
        prompts: {
            'logic.process.system': {
                ...
                // NOTE: dynamic fields are filled by the route.
